...
object PIDs {
    ...
    var list22: Array<PIDStruct?>? = arrayOf(
        ...
        PIDStruct(0x1004, 2, true, -40f,50f,    -30f, 45f,    0.7f, 0f,"x / 128",               "%05.2f","Ambient Air Temp",    "°C",     true),
    ...
    var list3E: Array<PIDStruct?>? = arrayOf(
        ...
        PIDStruct(0xd0019b75, 1, false,-100f,100f,   -1000f,1000f,  0.0f, 0f,"x",                 "%01.0f","Valve Lift Position", "",      true),
        PIDStruct(0xd00155b6, 2, false,0f,   220f,   -1000f,220f,   0.0f, 0f,"x / 100",           "%03.0f","Vehicle Speed",       "km/h",  true),
        PIDStruct(0xd0011e10, 2, false,-10f, 0f,     -1000f,1000f,  0.0f, 0f,"x / 655.35999997",  "%05.3f","Wastegate Actual",    "%",     true),
        PIDStruct(0xd0015c2c, 2, false,-10f, 0f,     -1000f,1000f,  0.0f, 0f,"x / 655.35999997",  "%05.3f","Wastegate Setpoint",  "%",     true),
        PIDStruct(0xd0015c5e, 2, false,-100f,100f,   -1000f,1000f,  0.0f, 0f,"x / 32",            "%03.1f","Wastegate Flow Req",  "kg/h",  true),
