...
object DIDs {
    ...
    val list3E: List<DIDStruct> = listOf(
        ...
        DIDStruct(0xd0013b16, 2, 35,false,-25f, 25f,    -20f,  1000f,  0f, "%02.2f","Injector PW DI",      "ms"),
        ...
        DIDStruct(0xd00098cc, 4, 11,false,0f,   3f,     -3f,   3f,     0f, "%01.0f","MAP",                 "bar"),
        DIDStruct(0xd00098f4, 4, 11,false,0f,   3f,     -3f,   3f,     0f, "%01.0f","MAP Setpoint",        "bar"),
        DIDStruct(0xd000c5ae, 1, 30,false,-25f, 120f,   -100f, 1000f,  0f, "%01.0f","Oil Temp",            "°C"),
        ...
        DIDStruct(0xd0015344, 2, 37,true, -40f, 500f,   -100f, 500f,   0f, "%07.2f","Torque Actual",       "Nm"),
        DIDStruct(0xd0011f0c, 2, 0, false,-100f,100f,   -100f, 500f,   0f, "%01.0f","Torque Limitation",   ""),
        DIDStruct(0xd0012048, 2, 37,true, -40f, 500f,   -100f, 500f,   0f, "%03.2f","Torque Requested",    "Nm"),
        ...
        DIDStruct(0xd00155b6, 2, 9, false,0f,   220f,   -20f,  220f,   0f, "%03.0f","Vehicle Speed",       "km/h"),
