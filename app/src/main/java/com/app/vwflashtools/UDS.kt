...
object DIDs {
    ...
    val list3E: List<DIDStruct> = listOf(
        //P1
        DIDStruct(0xd0012028, 2, 29,false,0f,   100f,   -1f,  101f,   0f, "%04.1f","Accelerator Pedal Position", "%"),
        DIDStruct(0xd0012400, 2, 0, false,0f,   7000f,  -1.0f,6000f,  0f, "%04.0f","Engine Speed",               "rpm"),
        DIDStruct(0xd00098fc, 4, 11,false,0f,   3f,     -1f,  2.8f,   0f, "%07.2f","PUT Actual",                 "bar"),
        DIDStruct(0xd00120e2, 2, 33,false,0.5f, 1.5f,   -0.1f,5f,     0f, "%04.2f","Lambda SAE",                 "l"),
        DIDStruct(0xd001988e, 1, 27,false,-5f,  5f,     -3.0f,3f,     0f, "%05.3f","Knock Retard Average",       "°"),
        DIDStruct(0xd00136ac, 2, 36,false,0f,   280000f,0f,   280000f,0f, "%08.1f","Fuel Pressure DI",           "bar"),
        DIDStruct(0xd00155b6, 2, 9, false,0f,   220f,   -20f, 200f,   0f, "%01.0f","Vehicle Speed",              "km/h"),
        DIDStruct(0xd000f00c, 1, 3, false,-25f, 25f,    -20f, 20f,    0f, "%01.0f","Short Term Fuel Trim",       "%"),
        ...
        DIDStruct(0xd000c177, 1, 28,false,0f,   15f,    6f,   15f,    0f, "%03.2f","Ambient Air Temperature",    "°C"),
        ...
        DIDStruct(0xd0011eba, 2, 32,false,-100f,100f,   -100f,100f,   0f, "%01.0f","Exhaust Pressure Desired",   "hPa"),
        DIDStruct(0xd0013640, 2, 36,false,0f,   100f,   -1f,  100f,   0f, "%03.2f","Fuel Pressure DI Setpoint",  "bar"),
        DIDStruct(0xd0011b26, 2, 25,false,-10f, 0f,     -4f,  1f,     0f, "%05.3f","Fuel Pressure MPI",          "bar"),
        DIDStruct(0xd001360c, 2, 25,false,-10f, 0f,     -4f,  1f,     0f, "%05.3f","Fuel Pressure MPI Setpoint", "bar"),
        DIDStruct(0xd000f39a, 1, 0, false,0f,   6f,     -1f,  100f,   0f, "%02.2f","Gear",                       "gear"),
        DIDStruct(0xd001363c, 2, 22,false,-100f,100f,   -100f,100f,   0f, "%01.0f","HPFP Effective Volume",      "%"),
        DIDStruct(0xd000e57e, 1, 21,false,-100f,100f,   -100f,100f,   0f, "%01.0f","Ignition Table Value",       "°"),
        DIDStruct(0xd000e59c, 1, 21,false,-100f,100f,   -100f,100f,   0f, "%01.0f","Ignition Timing Average",    "°"),
        DIDStruct(0xd000c179, 1, 28,false,-50f, 130f,   0f,   112f,   0f, "%03.2f","Intake Air Temperature",     "°C"),
        DIDStruct(0xd001566c, 2, 31,true, -100f,100f,   -100f,100f,   0f, "%01.0f","Intake Cam Position",        "°"),
        DIDStruct(0xd0013b16, 2, 35,false,-25f, 25f,    -20f, 20f,    0f, "%02.2f","Injector Pulsewidth DI",     "ms"),
        DIDStruct(0xd0013824, 2, 35,false,0f,   100f,   -1f,  101f,   0f, "%05.1f","Injector Pulsewidth MPI",    "ms"),
        DIDStruct(0xd0011e08, 2, 24,false,0f,   20f,    -1f,  10f,    0f, "%03.0f","Intake Flow Factor",         "-"),
        DIDStruct(0xd000efb1, 1, 27,false,0f,   250f,   10f,  250f,   0f, "%03.2f","Knock Retard Cylinder 1",    "°"),
        DIDStruct(0xd000efb2, 1, 27,false,0f,   2f,     0.7f, 4f,     0f, "%05.3f","Knock Retard Cylinder 2",    "°"),
        DIDStruct(0xd000efb3, 1, 27,false,0f,   2f,     0.7f, 4f,     0f, "%05.3f","Knock Retard Cylinder 3",    "°"),
        DIDStruct(0xd000efb4, 1, 27,false,0f,   2f,     0.7f, 4f,     0f, "%05.3f","Knock Retard Cylinder 4",    "°"),
        DIDStruct(0xd00143f6, 2, 34,false,-50f, 450f,   -100f,500f,   0f, "%03.2f","Lambda Setpoint",            "l"),
        DIDStruct(0xd0013600, 2, 22,false,0f,   100f,   -1f,  100f,   0f, "%01.0f","LPFP Duty Cycle",            "%"),
        DIDStruct(0xd000f00b, 1, 3, false,-100f,100f,   -100f,100f,   0f, "%01.0f","Long Term Fuel Trim",        "%"),
        ...
        DIDStruct(0xd00135e0, 2, 14,false,-100f,100f,   -100f,100f,   0f, "%01.0f","Mass Fuel Flow Desired",     "mg/stk"),
        DIDStruct(0xd0013636, 2, 14,false,-100f,100f,   -100f,100f,   0f, "%01.0f","Mass Fuel Flow",             "mg/stk"),
        DIDStruct(0xd00192b1, 1, 31,false,-100f,100f,   -100f,100f,   0f, "%01.0f","Mass Fuel Flow Split MPI",   ""),
        ...
        DIDStruct(0xd0011f0c, 2, 0, false,-100f,100f,   -100f,100f,   0f, "%01.0f","Torque Limitation Source",   ""),
        ...
        DIDStruct(0xd0015c2c, 2, 22,false,-10f, 0f,     -4f,  1f,     0f, "%05.3f","Wastegate Actuator Setpoint","%"),
        DIDStruct(0xd0011e10, 2, 22,false,-10f, 0f,     -4f,  1f,     0f, "%05.3f","Wastegate Actuator Actual",  "%"),
        DIDStruct(0xd0015c5e, 2, 37,false,-100f,100f,   -100f,100f,   0f, "%01.0f","Wastegate Flow Desired",     "kg/h"),
        DIDStruct(0xd001b6cd, 1, 0, false,-100f,100f,   -100f,100f,   0f, "%01.0f","Cruise Control Status",      ""),
    )
