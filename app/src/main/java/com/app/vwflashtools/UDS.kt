...
object DIDs {
    ...
    val list22: List<DIDStruct> = listOf(
        //P1
        DIDStruct(0x2033, 2, 19,false,0f,  220f,   -20f, 200f,   0f, 0f,  "%06.2f","Speed",               "km/hr"),
        DIDStruct(0xf40C, 2, 6, false,0f,  7000f,  -1f,  6000f,  0f, 0f,  "%06.1f","RPM",                 "rpm"),
        DIDStruct(0x39c0, 2, 8, false,0f,  300f,   0f,   300f,   0f, 0f,  "%05.1f","MAP Actual",          "kpa"),
        DIDStruct(0x39c2, 2, 8, false,0f,  300f,   0f,   300f,   0f, 0f,  "%05.1f","PUT Actual",          "kpa"),
        DIDStruct(0x10c0, 2, 16,false,0f,  2f,     0.7f, 4f,     0f, 0f,  "%05.3f","Lambda Actual",       "l"),
        DIDStruct(0x2004, 2, 9, true, -10f,10f,    -15f, 60f,    0f, 0f,  "%05.2f","Ignition angle",      "°"),
        DIDStruct(0x39a2, 2, 20,false,0f,  100f,   -1f,  100f,   0f, 0f,  "%02.2f","Wastegate Position",  "%"),
        DIDStruct(0x2032, 2, 17,false,0f,  1500f,  -1f,  1500f,  0f, 0f,  "%07.2f","Mass Airflow",        "g/s"),
        //P2
        DIDStruct(0x2950, 2, 16,false,0f,  2f,     0.7f, 4f,     0f, 0f,  "%05.3f","Lambda Specified",    "l"),
        ...
        //P3
        DIDStruct(0x200a, 2, 9, true, -10f,0f,     -4f,  1f,     0f, 0f,  "%05.3f","Retard cylinder 1",   "°"),
        DIDStruct(0x200b, 2, 9, true, -10f,0f,     -4f,  1f,     0f, 0f,  "%05.3f","Retard cylinder 2",   "°"),
        ...
        DIDStruct(0x4380, 2, 8, true, 0f,  500f,   -100f,500f,   0f, 0f,  "%04.1f","Torque requested",    "Nm"),
        DIDStruct(0x203c, 2, 0, false,0f,  2f,     -1f,  100f,   0f, 0f,  "%01.0f","Cruise control",      ""),
    )

    val list3E: List<DIDStruct> = listOf(
        DIDStruct(0xd0012400, 2, 0, false,0f,   7000f,  -1.0f, 6000f,  0f, 0f,  "%03.0f","Engine Speed",        "rpm"),
        DIDStruct(0xd00136ac, 2, 37,false,0f,   28000f, 0f,    28000f, 0f, 0f,  "%05.0f","Fuel Pressure DI",    "kpa"),
        DIDStruct(0xd000f00c, 1, 3, false,-25f, 25f,    -20f,  20f,    0f, 0f,  "%04.1f","Fuel Trim Short Term","%"),
        DIDStruct(0xd000c179, 1, 29,false,-50f, 70f,    -20f,  50f,    0f, 0f,  "%03.2f","Intake Air Temp",     "°C"),
        DIDStruct(0xd001988e, 1, 28,false,-5f,  5f,     -3.0f, 3f,     0f, 0f,  "%05.3f","Knock Retard",        "°"),
        DIDStruct(0xd00120e2, 2, 33,false,0.5f, 1.5f,   -0.1f, 5f,     0f, 0f,  "%04.2f","Lambda SAE",          "l"),
        DIDStruct(0xd00098fc, 4, 10,false,0f,   300f,   -1f,   300f,   0f, 0f,  "%05.1f","PUT Actual",          "kpa"),
        DIDStruct(0xd0011e76, 2, 4, false,0f,   195000f,-100f, 190000f,0f, 0f,  "%05.0f","Turbo Speed",         "rpm"),
        DIDStruct(0xd00097b4, 4, 1, false,0f,   2f,     -100f, 1000f,  0f, 0f,  "%05.3f","Airmass",             "g/stk"),
        DIDStruct(0xd00097fc, 4, 1, false,0f,   2f,     -100f, 1000f,  0f, 0f,  "%05.3f","Airmass Setpoint",    "g/stk"),
        DIDStruct(0xd000c177, 1, 29,false,-25f, 45f,    -100f, 100f,   0f, 0f,  "%03.2f","Ambient Air Temp",    "°C"),
        DIDStruct(0xd0013c76, 2, 35,false,0f,   110f,   0f,    120f,   0f, 0f,  "%03.2f","Ambient Pressure",    "kpa"),
        DIDStruct(0xd0015172, 2, 13,true, 10f,  15f,    7f,    16f,    0f, 0f,  "%01.0f","Battery Volts",       "V"),
        DIDStruct(0xd000c36e, 1, 0, false,-10f, 10f,    -100f, 100f,   0f, 0f,  "%05.2f","Combustion Mode",     ""),
        DIDStruct(0xd000c6f5, 1, 29,false,-50f, 130f,   -100f, 150f,   0f, 0f,  "%03.0f","Coolant Temp",        "°C"),
        DIDStruct(0xd001397a, 2, 21,false,-100f,100f,   -1000f,1000f,  0f, 0f,  "%01.0f","EOI Limit",           "°"),
        DIDStruct(0xd0013982, 2, 21,false,-100f,100f,   -1000f,1000f,  0f, 0f,  "%01.0f","EOI Actual",          "°"),
        DIDStruct(0xd000c1d4, 1, 24,false,-100f,100f,   -100f, 100f,   0f, 0f,  "%01.0f","Ethanol Content",     "%"),
        DIDStruct(0xd0011e04, 2, 25,false,0f,   1.5f,   -1f,   10f,    0f, 0f,  "%03.2f","Exhaust Flow Factor", ""),
        DIDStruct(0xd001566e, 2, 5, true, -45f, 45f,    -100f, 100f,   0f, 0f,  "%04.1f","Exhaust Cam Position","°"),
        DIDStruct(0xd0011eba, 2, 35,false,0f,   500f,   -100f, 1000f,  0f, 0f,  "%03.0f","Exhaust Pres Desired","kpa"),
        DIDStruct(0xd00135e0, 2, 14,false,-100f,100f,   -100f, 1000f,  0f, 0f,  "%01.0f","Fuel Flow Desired",   "mg/stk"),
        DIDStruct(0xd0013636, 2, 14,false,-100f,100f,   -100f, 1000f,  0f, 0f,  "%01.0f","Fuel Flow",           "mg/stk"),
        DIDStruct(0xd00192b1, 1, 5, false,-100f,100f,   -100f, 100f,   0f, 0f,  "%01.0f","Fuel Flow Split MPI", ""),
        DIDStruct(0xd0013600, 2, 23,false,0f,   100f,   -1000f,100f,   0f, 0f,  "%01.0f","Fuel LPFP Duty",      "%"),
        DIDStruct(0xd0011b26, 2, 31,false,0f,   1500f,  -1000f,2000f,  0f, 0f,  "%04.0f","Fuel LPFR",           "kpa"),
        ...
        DIDStruct(0xd001566c, 2, 5, true, -100f,100f,   -100f, 100f,   0f, 0f,  "%01.0f","Intake Cam Position", "°"),
        ...
        DIDStruct(0xd000e578, 1, 28,true, 0f,   220f,   -1000f,1000f,  0f, 0f,  "%03.2f","openflex_cor",        "°CRK"),
        DIDStruct(0xd001de8d, 1, 28,true, 0f,   7000f,  -1000f,1000f,  0f, 0f,  "%06.1f","openflex_max_cor",    "°CRK"),
        DIDStruct(0xd001de8e, 1, 5, false,0f,   3f,     -1000f,1000f,  0f, 0f,  "%05.3f","openflex_fac_cor",    ""),
        DIDStruct(0xd0012028, 2, 15,false,0f,   100f,   -1000f,1000f,  0f, 0f,  "%04.1f","Pedal Position",      "%"),
        DIDStruct(0xd0000aa1, 1, 0, false,0f,   1f,     -1000f,1000f,  0f, 0f,  "%01.0f","Port Flap Position",  ""),
        DIDStruct(0xd0011eee, 2, 35,false,0f,   300f,   -1000f,1000f,  0f, 0f,  "%05.1f","PUT Setpoint",        "kpa"),
        DIDStruct(0xd0013a42, 2, 21,false,-100f,100f,   -1000f,1000f,  0f, 0f,  "%01.0f","SOI Limit",           "°"),
        DIDStruct(0xd0013a44, 2, 21,false,-100f,100f,   -1000f,1000f,  0f, 0f,  "%01.0f","SOI Actual",          "°"),
        DIDStruct(0xd000f377, 1, 27,false,0.5f, 1.3f,   -1000f,1000f,  0f, 0f,  "%07.2f","TPS",                 "%"),
        DIDStruct(0xd0015344, 2, 12,true, -40f, 500f,   -1000f,1000f,  0f, 0f,  "%07.2f","Torque Actual",       "Nm"),
        DIDStruct(0xd0011f0c, 2, 0, false,-100f,100f,   -1000f,1000f,  0f, 0f,  "%01.0f","Torque Limitation",   ""),
        DIDStruct(0xd0012048, 2, 12,true, -40f, 500f,   -1000f,500f,   0f, 0f,  "%03.2f","Torque Requested",    "Nm"),
        DIDStruct(0xd000f3c1, 1, 30,false,-100f,100f,   -1000f,120f,   0f, 0f,  "%01.0f","Transmission Temp",   "°C"),
        DIDStruct(0xd0019b75, 1, 0, false,-100f,100f,   -1000f,1000f,  0f, 0f,  "%01.0f","Valve Lift Position", ""),
        DIDStruct(0xd00155b6, 2, 9, false,0f,   220f,   -1000f,220f,   0f, 0f,  "%03.0f","Vehicle Speed",       "km/h"),
