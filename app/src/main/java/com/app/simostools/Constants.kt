...
enum class COMPATIBLE_BOXCODE_VERSIONS(val str: String, val allowedBoxCodes: Array<String>, val boxCodeLocation: IntArray, val ecm3Range: IntArray, val software: SIMOS_18) {
    ...
    _8V0906264K("8V0906264K", arrayOf("8V0906264K", "8V0906264A", "8V0906264D", "8V0906264F"), intArrayOf(0x60, 0x6B), intArrayOf(55724,66096), SIMOS_18._1),
    ...
    _8V0906259N("8V0906259N", arrayOf("8V0906259N"), intArrayOf(0x60,0x6B), intArrayOf(60096,72936), SIMOS_18._10),
